...
module.exports = class Soap {
     ...
     * @param {Array<string>} properties - Properties which should be retrieved
     ...
     *
     * @param {string} type -SOAP Object type
     * @param {Array<string>} properties - Properties which should be created
     * @param {object} [requestParameters] - additional RetrieveRequest parameters, for example filter or options
     * @returns {Promise<object>} SOAP object converted from XML
     */
     ...
     *
     * @param {string} type -SOAP Object type
     * @param {Array<string>} properties - Properties which should be updated
     * @param {object} [requestParameters] - additional RetrieveRequest parameters, for example filter or options
     * @returns {Promise<object>} SOAP object converted from XML
     */
