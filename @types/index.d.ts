...
export default class SDK {
     ...
     *
     * @param {import('./auth.js').AuthObject} authObject Auth Object for making requests
     ...
     */
    constructor(authObject: import("./auth.js").AuthObject, options?: {
        requestAttempts?: number | undefined;
        retryOnConnectionError?: boolean | undefined;
        eventHandlers?: object | undefined;
    });
    auth: Auth;
    rest: Rest;
    soap: Soap;
